...
$context["item"], "below", [], "any", false, false, true, 64)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("secondary-nav__menu-link--has-children") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--secondary-menu.html.twig", "C:\\Users\\Soham Lad\\OneDrive\\Desktop\\drpy\\web\\core\\themes\\olivero\\templates\\navigation\\menu--secondary-menu.html.twig");
    }
